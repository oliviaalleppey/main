    ...
    return (
        <main className="min-h-screen bg-[#F6F1E8]">
            ...
            <section className="py-28 px-6 bg-gradient-to-b from-white via-[#FBFBF9] to-white relative overflow-hidden">
                {/* Decorative Elements */}
                <div className="absolute top-0 left-0 w-64 h-64 bg-[#C5A059]/5 rounded-full blur-3xl" />
                <div className="absolute bottom-0 right-0 w-64 h-64 bg-[#C5A059]/5 rounded-full blur-3xl" />

                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="text-center mb-20">
                        <div className="flex items-center justify-center gap-4 mb-5">
                            <span className="w-12 h-[1px] bg-[#C5A059]" />
                            <p className="text-[#7A5E28] text-[11px] tracking-[0.4em] uppercase">Premium Services</p>
                            <span className="w-12 h-[1px] bg-[#C5A059]" />
                        </div>
                        ...
                        {[
                            ...
                            <div key={amenity.title} className="group bg-white p-10 border border-[#C9A961]/10 hover:border-[#C9A961]/30 hover:shadow-xl transition-all duration-500">
                                <div className="w-16 h-16 bg-gradient-to-br from-[#C9A961]/10 to-[#C9A961]/5 rounded-full flex items-center justify-center mb-6 group-hover:from-[#C9A961]/20 group-hover:to-[#C9A961]/10 transition-all duration-500">
                                    <amenity.icon className="w-8 h-8 text-[#7A5E28]" />
                                </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="order-1 md:order-2">
                            <p className="text-[#7A5E28] text-[11px] tracking-[0.4em] uppercase mb-4">Why Choose Us</p>
                            <h2 className="font-serif text-4xl md:text-5xl text-[#1C1C1C] mb-6 tracking-tight leading-tight">
                                Exceptional Service,<br />
                                <span className="text-[#7A5E28] italic">Flawless Execution</span>
                            </h2>
                            ...
                            <div className="grid grid-cols-2 gap-6 mb-10">
                                {[
                                    ...
                                    <div key={stat.label} className="border-l-2 border-[#C9A961] pl-4">
                                        <p className="text-4xl font-serif text-[#7A5E28] mb-1">{stat.value}</p>
                            ...
                            <div className="space-y-3">
                                {[
                                    ...
                                    <div key={feature} className="flex items-center gap-3">
                                        <CheckCircle2 className="w-5 h-5 text-[#7A5E28] flex-shrink-0" />
            ...
            <section className="relative py-32 px-6 overflow-hidden">
                ...
                <div className="absolute inset-0 opacity-10 z-0">
                    <div className="absolute top-20 left-20 w-96 h-96 bg-[#C5A059] rounded-full blur-3xl" />
                    <div className="absolute bottom-20 right-20 w-96 h-96 bg-[#C5A059] rounded-full blur-3xl" />
                </div>

                <div className="max-w-5xl mx-auto text-center relative z-10">
                    <div className="flex items-center justify-center gap-4 mb-6">
                        <span className="w-16 h-[1px] bg-[#C5A059]" />
                        <p className="text-[#7A5E28] text-[11px] tracking-[0.5em] uppercase">Get Started</p>
                        <span className="w-16 h-[1px] bg-[#C5A059]" />
                    </div>
                    <h2 className="font-serif text-4xl md:text-6xl text-white mb-6 tracking-tight leading-tight">
                        Ready to Plan Your<br />
                        <span className="text-[#7A5E28] italic">Perfect Event?</span>
                    </h2>
                    ...
                    <div className="flex flex-col sm:flex-row gap-5 justify-center">
                        <Link
                            href="/contact?type=corporate"
                            className="group inline-flex items-center justify-center gap-3 bg-[#C5A059] hover:bg-[#D4B76A] text-[#1C1C1C] px-12 py-5 text-[11px] tracking-[0.25em] uppercase font-semibold transition-all duration-300 shadow-2xl hover:shadow-[#C9A961]/30"
                        >
                            Request Proposal
                            <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                        </Link>
