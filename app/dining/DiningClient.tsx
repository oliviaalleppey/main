            ...
            <main className="min-h-screen bg-[#FAF8F3] text-[#26322D]">
                ...
                <section className="relative h-[44vh] md:h-[52vh] w-full overflow-hidden">
                    ...
                    <div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-6">
                        ...
                        <motion.h1
                            ...
                            className="text-[2.6rem] sm:text-[3.5rem] md:text-[5.5rem] lg:text-[7.5rem] font-serif font-medium text-white mb-5 tracking-[-0.03em] leading-[0.92] [text-shadow:0_2px_22px_rgba(0,0,0,0.55)]"
                        >
                            Dining
                        </motion.h1>
                ...
                <section className="border-b border-[#E8E0D2] bg-[#F6F1E7]">
                    <div className="max-w-6xl mx-auto px-6 md:px-10 py-6 md:py-7 grid grid-cols-2 md:grid-cols-4 gap-5">
                        {[
                            { label: 'Dining Outlets', value: '6 Outlets' },
                            { label: 'Total Covers', value: '360+' },
                            { label: 'Cuisine', value: 'Local & Global' },
