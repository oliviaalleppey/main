...
const BEVERAGES: MenuSection[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { name: 'Aerated Water', desc: 'Coca Cola / Coke Diet / Sprite / Fanta / Soda Water', price: 165 },
            { name: 'Ginger Ale / Tonic Water', price: 185 },
            { name: 'Energy Drink — Red Bull', price: 315 },
            { name: 'Choice Of Fresh Juice', price: 285 },
            { name: 'Choice Of Milk Shakes', desc: 'Vanilla / Chocolate / Strawberry', price: 295 },
            { name: 'Fresh Lime Juice / Soda', price: 125 },
            { name: 'Lassi / Buttermilk', desc: 'Sweet or Salted', price: 185 },
            { name: 'Milk', price: 245 },
            { name: 'Hot Chocolate', price: 245 },
            { name: 'Healthy Drinks', desc: 'Horlicks / Boost', price: 245 },
            {
