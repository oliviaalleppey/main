...
export default async function MediaPage() {
    ...
    return (
        <div className="p-8 max-w-5xl mx-auto">
            <div className="mb-8">
                <h1 className="text-3xl font-serif text-[var(--text-dark)] flex items-center gap-3">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col md:flex-row gap-8">
                ...
                <div className="flex-1">
                    <h2 className="text-lg font-medium text-[var(--text-dark)] mb-4">Current Home Page Hero</h2>
                ...
                {/* Upload Form */}
                <div className="flex-1">
                    <h2 className="text-lg font-medium text-[var(--text-dark)] mb-4">Upload New Media</h2>
                    <MediaUploadForm />
                </div>
            </div>
        </div>
