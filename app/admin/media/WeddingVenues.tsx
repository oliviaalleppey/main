...
import { setWeddingVenueImage, setWeddingSectionImage } from './actions';
...
const VENUES = [
    { key: 'grand_ballroom', label: 'Grand Ballroom' },
    { key: 'forum_hall', label: 'Forum Hall' },
    { key: 'pool_side', label: 'Pool Side Venue' },
];
...
export default function WeddingVenues({ venueImages: initialVenueImages, sectionImages: initialSectionImages }: Props) {
    ...
    const handleVenueUpload = async (key: string, file: File) => {
        ...
        try {
            ...
            const result = await setWeddingVenueImage(key, fd);
    ...
    const handleSectionUpload = async (key: string, file: File) => {
        ...
        try {
            ...
            const fd = new FormData();
            fd.append('url', blob.url);
            const result = await setWeddingSectionImage(key, fd);
