            ...
            <section id="venue-details" className="py-24 px-6 md:px-12">
                <div className="max-w-6xl mx-auto">
                    <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
                        ...
                        {/* Content */}
                        <div>
                            <p className="text-[var(--gold-accent-dark)] text-sm tracking-[0.3em] uppercase mb-4">Our Venue</p>
                            ...
                            <div className="grid grid-cols-2 gap-6 mb-8">
                                <div className="bg-white p-6 border border-gray-200">
                                    <p className="text-4xl font-serif text-[var(--brand-primary)] mb-2">500+</p>
                                    <p className="text-sm text-[#59544D] uppercase tracking-wider">Seating Capacity</p>
                                </div>
                                <div className="bg-white p-6 border border-gray-200">
                                    <p className="text-4xl font-serif text-[var(--brand-primary)] mb-2">800+</p>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mb-24">
                        <div className="text-center p-8 bg-white border border-[#DED6CB] hover:border-[var(--gold-accent)] transition-colors">
                            ...
                            <h3 className="text-xl font-serif text-[var(--text-dark)] mb-4">Weddings</h3>
                        ...
                        <div className="text-center p-8 bg-white border border-[#DED6CB] hover:border-[var(--gold-accent)] transition-colors">
                            ...
                            <h3 className="text-xl font-serif text-[var(--text-dark)] mb-4">Corporate Events</h3>
                            <p className="text-[#59544D] text-sm leading-relaxed">
                        ...
                        <div className="text-center p-8 bg-white border border-[#DED6CB] hover:border-[var(--gold-accent)] transition-colors">
                            ...
                            <h3 className="text-xl font-serif text-[var(--text-dark)] mb-4">Celebrations</h3>
                            <p className="text-[#59544D] text-sm leading-relaxed">
                    ...
                    <div className="max-w-3xl mx-auto bg-white p-8 md:p-12 border border-gray-200">
                        <h2 className="text-3xl font-serif text-[var(--text-dark)] mb-4 text-center tracking-wide">
                            Plan Your Event
                        </h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-sm text-[var(--text-dark)] mb-2">Your Name *</label>
                                    <input
                                        type="text"
                                        required
                                        value={formData.name}
                                ...
                                <div>
                                    <label className="block text-sm text-[var(--text-dark)] mb-2">Email *</label>
                                    <input
                                        type="email"
                                        required
                                ...
                                <div>
                                    <label className="block text-sm text-[var(--text-dark)] mb-2">Phone *</label>
                                    <input
                                        type="tel"
                                        required
                                ...
                                <div>
                                    <label className="block text-sm text-[var(--text-dark)] mb-2">Event Type *</label>
                                    <select
                                        required
                                ...
                                <div>
                                    <label className="block text-sm text-[var(--text-dark)] mb-2">Event Date *</label>
                                    <input
                                        type="date"
                                        required
                                ...
                                <div>
                                    <label className="block text-sm text-[var(--text-dark)] mb-2">Expected Guest Count *</label>
                                    <input
                                        type="number"
                                        required
                            ...
                            <div>
                                <label className="block text-sm text-[var(--text-dark)] mb-2">Additional Details</label>
                                <textarea
