                            ...
                            <div className="space-y-8 mb-12">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[#59544D]">
                                            Primary (Landline):{' '}
                                            <a href="tel:+914772250888" className="hover:text-[var(--gold-accent-dark)] transition-colors">+91/0 4772250888</a>
                                            ,{' '}
                                            <a href="tel:+914772250800" className="hover:text-[var(--gold-accent-dark)] transition-colors">+91/0 4772250800</a><br />
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 className="font-medium text-[var(--text-dark)] mb-1">Legal Information</h3>
                                        <p className="text-[#59544D]">
                                            Owned and Operated by<br />
                                            <span className="font-medium">Olivia Hospitalities Private Limited</span><br />
