...
import EnergeticMusic from '@/components/ui/energetic-music';
        ...
        <main className="min-h-screen bg-[#0A0A0A] text-[#F4F5F0] selection:bg-[#E95D20] selection:text-white pb-24 overflow-hidden relative">
            ...
            <section className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 w-full h-full">
                    <Image
                        src="https://images.unsplash.com/photo-1514525253161-7a46d19cd819?q=100&w=2800&auto=format&fit=crop"
                        alt="High Energy Pub Party"
                        fill
                        unoptimized
