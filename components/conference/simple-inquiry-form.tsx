...
const INITIAL_STATE: SimpleFormState = {
    name: '',
    phone: '',
    preferredDate: '',
    guestCount: '',
...
export default function SimpleInquiryForm() {
    const [form, setForm] = useState<SimpleFormState>(INITIAL_STATE);
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-sm text-[#5A564E] leading-relaxed">
                                    Your event enquiry has been shared with our team. We will be in touch shortly.
                                </p>
                            </div>
                        </div>
